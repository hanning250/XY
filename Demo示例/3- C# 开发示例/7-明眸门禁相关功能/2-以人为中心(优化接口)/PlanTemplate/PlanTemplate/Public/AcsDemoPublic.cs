...
namespace PlanTemplate
{
    ...
    public class AcsDemoPublic
    {
        ...
        public static readonly string[] strVerify = {"invalid", "sleep", "card and password", "card", "card or password", "fingerprint", "fingerprint and password", "fingerprint or card",
                                                 ...
                                                 "face or face and swipe card", "fingerprint or face", "card or face or password", "card or face", "card or face or fingerprint", "card or fingerprint or password"};
        ...
        public static readonly string[] strCardType = { "unknown", "ordinary card", "disabled card", "block list card", "patrol card", "stress card", "super card", "guest card", "remove card", 
