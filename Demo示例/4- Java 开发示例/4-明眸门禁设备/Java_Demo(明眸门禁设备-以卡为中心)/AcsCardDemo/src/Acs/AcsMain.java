...
public class AcsMain {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException, InterruptedException, JSONException {
        ...
        //设备登录
        lUserID = loginDevice("10.9.137.105", (short) 7000, "admin", "hik12345");    //登陆设备
        ...
        for (boolean exit = false; !exit; ) {
            ...
            switch (str) {
                ...
                case "4": {
                    System.out.println("\n[Module]下发卡号示例代码");
                    CardManage.setOneCard(lUserID, "12345", 123456, (short) 1);
                    break;
                }
                case "5": {
                    System.out.println("\n[Module]查询卡号示例代码");
                    CardManage.getOneCard(lUserID, "12345");
                    break;
                }
                case "6": {
                    System.out.println("\n[Module]查询所有卡号示例代码");
                ...
                case "7": {
                    System.out.println("\n[Module]删除卡号代码");
                    CardManage.delOneCard(lUserID, "12345");
                    break;
                }
                case "8": {
                    //
                ...
                case "10": {
                    //先下发卡号，卡号上绑定人脸图片
                    System.out.println("\n[Module]二进制方式下发人脸代码");
                    FaceManage.setOneFace(lUserID, "12345");
                    break;
                }
                case "11": {
                    //根据卡号查询人脸图片
                    System.out.println("\n[Module]查询人脸代码");
                    FaceManage.getFaceCfg(lUserID, "12345");
                    break;
                }
                case "12": {
                    //根据卡号删除人脸图片
                    System.out.println("\n[Module]删除人脸代码");
                    FaceManage.delOneFace(lUserID, "12345");
                    break;
                }
                case "13": {
                    System.out.println("\n[Module]采集人脸代码");
                ...
                case "15": {
                    System.out.println("\n[Module]设置门状态计划模板代码");
                    DoorManage.doorTemplate(lUserID,2);
                    break;
                }
                default: {
                    System.out.println("\n未知的指令操作!请重新输入!\n");
