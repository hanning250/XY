...
//      static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
     ...
     *************************************************/
    public JDialogUserConfig(java.awt.Frame parent, boolean modal, int lUserID, HCNetSDK.NET_DVR_DEVICEINFO_V30 strDeviceInfo, HCNetSDK.NET_DVR_IPPARACFG  strIpparaCfg) {
        super(parent, modal);
        initComponents();
    ...
    {//GEN-HEADEREND:event_jButtonSetupActionPerformed
        ...
        boolean setDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_SetDVRConfig(m_lUserID, HCNetSDK.NET_DVR_SET_USERCFG_V30,
                0, lpConfig, m_struUserCfg.size());
        m_struUserCfg.read();
    ...
    {//GEN-HEADEREND:event_jButtonUPdateActionPerformed
       ...
       boolean getDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_GetDVRConfig(m_lUserID, HCNetSDK.NET_DVR_GET_USERCFG_V30, 0, lpPicConfig, m_struUserCfg.size(), new IntByReference(0));
       m_struUserCfg.read();
