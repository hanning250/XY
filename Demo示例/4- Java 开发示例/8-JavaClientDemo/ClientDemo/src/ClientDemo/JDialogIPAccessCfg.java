...
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
     ...
     *************************************************/
    public JDialogIPAccessCfg(java.awt.Frame parent, boolean modal, int lUserID, HCNetSDK.NET_DVR_DEVICEINFO_V30 strDeviceInfo) {
        super(parent, modal);
        initComponents();
	...
	for (i = 0; i < ClientDemo.hCNetSDK.MAX_IP_DEVICE; i++)
	{
		//find existed device
    ...
    {//GEN-HEADEREND:event_jButtonSaveActionPerformed
        ...
        boolean setDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_SetDVRConfig(m_lUserID, HCNetSDK.NET_DVR_SET_IPPARACFG,
                0, lpNetConfig, m_strIpparaCfg.size());
        m_strIpparaCfg.read();
    ...
    private void initialDialog()
    {
        ...
        m_bGetIpCfg = ClientDemo.hCNetSDK.NET_DVR_GetDVRConfig(m_lUserID, HCNetSDK.NET_DVR_GET_IPPARACFG, 0, lpIpParaConfig, m_strIpparaCfg.size(), ibrBytesReturned);
        m_strIpparaCfg.read();
	...
	SetCtrlStat(2);
        ...
        if (m_bGetIpCfg)
        {
            for (i = 0; i < ClientDemo.hCNetSDK.MAX_CHANNUM_V30; i++)
            {
