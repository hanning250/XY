...
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
     ...
     *************************************************/
    public JDialogPTZCruise(java.awt.Frame parent, boolean modal, int lRealHandle)
    {
        super(parent, modal);
        initComponents();
        initDialog();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        m_iSeqPoint = jComboBoxCruisePoint.getSelectedIndex() + 1;
        m_iPresetNum = jComboBoxPresetPoint.getSelectedIndex() + 1;
        if (!ClientDemo.hCNetSDK.NET_DVR_PTZCruise(m_lRealHandle, HCNetSDK.CLE_PRE_SEQ, (byte) m_iCruiseNum, (byte) m_iSeqPoint, (short) m_iPresetNum))
        {
    ...
    {
        if (!ClientDemo.hCNetSDK.NET_DVR_PTZCruise(m_lRealHandle, dwPTZCruiseCmd, byCruiseRoute, byCruisePoint, wInput))
        {
