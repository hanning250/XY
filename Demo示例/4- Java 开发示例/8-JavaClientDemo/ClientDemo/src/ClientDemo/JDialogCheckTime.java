...
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
     ...
     *************************************************/
    public JDialogCheckTime(java.awt.Frame parent, boolean modal, int userId)
    {
        super(parent, modal);
        initComponents();
        m_lUserId = userId;
    ...
    private void jToggleButtonCheckTimeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonCheckTimeActionPerformed
        ...
        boolean setDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_SetDVRConfig(m_lUserId, HCNetSDK.NET_DVR_SET_TIMECFG,
                0, lpPicConfig, strCurTime.size());
        strCurTime.read();
