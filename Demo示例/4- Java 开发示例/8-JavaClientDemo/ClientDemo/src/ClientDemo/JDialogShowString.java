...
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
     ...
     *************************************************/
    public JDialogShowString(java.awt.Dialog parent, boolean modal, HCNetSDK.NET_DVR_SHOWSTRING_V30 strShowString, int UserID, int chanNumber)
    {
        super(parent, modal);
    ...
    private void jButtonSetUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSetUpActionPerformed
        ...
        boolean setDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_SetDVRConfig(lUserID, HCNetSDK.NET_DVR_SET_SHOWSTRING_V30,
                this.iChannelNumber, lpShowString, m_strShowString.size());
