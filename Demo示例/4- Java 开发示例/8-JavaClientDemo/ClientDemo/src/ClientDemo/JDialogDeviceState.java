...
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
     ...
     *************************************************/
    public JDialogDeviceState(java.awt.Frame parent, boolean modal, int lUserID, HCNetSDK.NET_DVR_DEVICEINFO_V30 strDeviceInfo, String sIP)
    {
        super(parent, modal);
        m_lUserID = lUserID;
 ...
 private void jButtonExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExitActionPerformed
    ...
    private void showState()
    {
        ...
        boolean getDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_GetDVRWorkState_V30(m_lUserID, m_strWorkState);
        ...
        getDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_GetDVRConfig(m_lUserID, HCNetSDK.NET_DVR_GET_IPPARACFG, 0, lpIpParaConfig, m_strIpparaCfg.size(), ibrBytesReturned);
        m_strIpparaCfg.read();
        if (getDVRConfigSuc != true)
        {//设备不支持,则表示没有IP通道
