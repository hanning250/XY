...
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
    int m_lUserID;//用户ID
    int m_lPlayHandle;//播放句柄
    int m_lLoadHandle;//下载句柄
     ...
     *************************************************/
    public JDialogPlayBackByTime(java.awt.Frame parent, boolean modal, int lUserID, String sIP) {
        super(parent, modal);
        initComponents();
        initialDialog();
        m_lUserID = lUserID;
 ...
 *************************************************/
    ...
    {//GEN-HEADEREND:event_jSliderAudioMouseReleased
        	if (m_lPlayHandle >= 0)
		{
			if (ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, HCNetSDK.NET_DVR_PLAYAUDIOVOLUME, jSliderAudio.getValue(), null))
			{
...
*************************************************/
    ...
    {//GEN-HEADEREND:event_jButtonDownloadActionPerformed
        if (m_lLoadHandle == -1)
        {
            ...
            m_lLoadHandle = ClientDemo.hCNetSDK.NET_DVR_GetFileByTime(m_lUserID, m_iChanShowNum, struStartTime, struStopTime, sFileName);
            if (m_lLoadHandle >= 0)
            {
                ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lLoadHandle, HCNetSDK.NET_DVR_PLAYSTART, 0, null);
            ...
            } else
            {
                ...
                System.out.println("laste error " + ClientDemo.hCNetSDK.NET_DVR_GetLastError());
                return;
            }
        } 
        else
        {
            ClientDemo.hCNetSDK.NET_DVR_StopGetFile(m_lLoadHandle);
            jButtonDownload.setText("下载");
...
*************************************************/
    ...
    {//GEN-HEADEREND:event_jButtonSaveActionPerformed
        ...
        if (!m_bTimeSave)
        {
            ...
            if (ClientDemo.hCNetSDK.NET_DVR_PlayBackSaveData(m_lPlayHandle, sFileName))
            {
                m_bTimeSave = true;
        ...
        {
            ClientDemo.hCNetSDK.NET_DVR_StopPlayBackSave(m_lPlayHandle);
            m_bTimeSave = false;
            jButtonSave.setText("保存");
        }
       ...
       HCNetSDK.NET_DVR_TIME struStopTime;
        ...
        if (m_lPlayHandle == -1)
        {
            ...
            if (m_lPlayHandle == -1)
            {
                ...
                //还要调用该接口才能开始回放
                ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, HCNetSDK.NET_DVR_PLAYSTART, 0, null);
                System.out.println("开始回放");
            }

            if (ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, HCNetSDK.NET_DVR_PLAYSTARTAUDIO, 0, null))
            {
                m_bSound = true;
                ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, HCNetSDK.NET_DVR_PLAYAUDIOVOLUME, (0xffff) / 2, null);
        ...
        } else
        {
            if (m_bPause)
            {
                if (ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, HCNetSDK.NET_DVR_PLAYRESTART, 0, null))
                {
            ...
            {
                if (ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, HCNetSDK.NET_DVR_PLAYPAUSE, 0, null))
                {
 ...
 *************************************************/
    ...
    {//GEN-HEADEREND:event_jButtonSlowActionPerformed
       	ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, ClientDemo.hCNetSDK.NET_DVR_PLAYSLOW, 0, null);
 ...
 *************************************************/
    ...
    {//GEN-HEADEREND:event_jButtonFastActionPerformed
        ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, ClientDemo.hCNetSDK.NET_DVR_PLAYFAST, 0, null);
...
*************************************************/
	...
	if (ClientDemo.hCNetSDK.NET_DVR_PlayBackCaptureFile(m_lPlayHandle,sPicName))
	{
...
*************************************************/
       ...
       if (m_lPlayHandle >= 0)
	{
		if (m_bSound)
		{
			if (ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, HCNetSDK.NET_DVR_PLAYSTOPAUDIO, 0, null))
			{
				m_bSound = false;
				jButtonAudio.setText("Mute");
			}
 ...
 *************************************************/
    class DownloadTask extends java.util.TimerTask
    {
        ...
        public void run()
        {
            ...
            ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lLoadHandle, HCNetSDK.NET_DVR_PLAYGETPOS, 0, nPos);
...
*************************************************/
    class PlaybackTask extends java.util.TimerTask
    {
        ...
        public void run()
        {
            	...
            	if (m_lPlayHandle >= 0)
		{
			if (ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, HCNetSDK.NET_DVR_PLAYGETPOS, 0, nPos))
			{
...
*************************************************/
        ...
        if (m_lPlayHandle >= 0)
	{
		...
		ClientDemo.hCNetSDK.NET_DVR_PlayBackControl(m_lPlayHandle, HCNetSDK.NET_DVR_PLAYSTOPAUDIO, 0, null);
		ClientDemo.hCNetSDK.NET_DVR_StopPlayBack(m_lPlayHandle);
		m_lPlayHandle=-1;
