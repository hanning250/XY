...
public class JFramePTZControl extends javax.swing.JFrame
{
    ...
    /************成员变量*****************/
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
    private int m_lRealHandle;//预览句柄
     ...
     *************************************************/
    public JFramePTZControl(int lRealHandle)
    {
    ...
    private void jButtonAutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAutoActionPerformed
        ...
        if (!m_bAutoOn)
        {
            if (iSpeed >= 1)
            {
                ClientDemo.hCNetSDK.NET_DVR_PTZControlWithSpeed(m_lRealHandle, HCNetSDK.PAN_AUTO, 0, iSpeed);
            } else
            {
                ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.PAN_AUTO, 0);
            }
        ...
        } else
        {
            if (iSpeed >= 1)
            {
                ClientDemo.hCNetSDK.NET_DVR_PTZControlWithSpeed(m_lRealHandle, HCNetSDK.PAN_AUTO, 1, iSpeed);
            } else
            {
                ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.PAN_AUTO, 1);
            }
            jButtonAuto.setText("自动");
            m_bAutoOn = false;
        }
    ...
    private void jButtonLightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLightActionPerformed
        if (!m_bLightOn)
        {
            ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.LIGHT_PWRON, 0);
            jButtonLight.setText("关灯");
            m_bLightOn = true;
        } else
        {
            ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.LIGHT_PWRON, 1);
            jButtonLight.setText("灯光");
            m_bLightOn = false;
        }
    ...
    private void jButtonWiperPwronActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonWiperPwronActionPerformed
        if (!m_bWiperOn)
        {
            ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.WIPER_PWRON, 0);
            jButtonWiperPwron.setText("雨停");
            m_bWiperOn = true;
        } else
        {
            ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.WIPER_PWRON, 1);
            jButtonWiperPwron.setText("雨刷");
            m_bWiperOn = false;
        }
    ...
    private void jButtonFanPwronActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFanPwronActionPerformed
        if (!m_bFanOn)
        {
            ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.FAN_PWRON, 0);
            jButtonFanPwron.setText("停风");
            m_bFanOn = true;
        } else
        {
            ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.FAN_PWRON, 1);
            jButtonFanPwron.setText("风扇");
            m_bFanOn = false;
        }
    ...
    private void jButtonHeaterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHeaterActionPerformed
        if (!m_bHeaterOn)
        {
            ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.HEATER_PWRON, 0);
            jButtonHeater.setText("停止");
            m_bHeaterOn = true;
        } else
        {
            ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.HEATER_PWRON, 1);
            jButtonHeater.setText("加热");
            m_bHeaterOn = false;
        }
    ...
    private void jButtonAux1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAux1ActionPerformed
        if (!m_bAuxOn1)
        {
            ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.AUX_PWRON1, 0);
            jButtonAux1.setText("停止1");
            m_bAuxOn1 = true;
        } else
        {
            ClientDemo.hCNetSDK.NET_DVR_PTZControl(m_lRealHandle, HCNetSDK.AUX_PWRON1, 1);
    ...
    private void jButtonTrackStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTrackStartActionPerformed
        if (!ClientDemo.hCNetSDK.NET_DVR_PTZTrack(m_lRealHandle, HCNetSDK.STA_MEM_CRUISE))
        {
            JOptionPane.showMessageDialog(this, "开始记录路线失败");
            return;
        }
    ...
    private void jButtonTrackStopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTrackStopActionPerformed
        if (!ClientDemo.hCNetSDK.NET_DVR_PTZTrack(m_lRealHandle, HCNetSDK.STO_MEM_CRUISE))
        {
            JOptionPane.showMessageDialog(this, "停止记录路线失败");
            return;
        }
    ...
    private void jButtonTrackRunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTrackRunActionPerformed
        if (!ClientDemo.hCNetSDK.NET_DVR_PTZTrack(m_lRealHandle, HCNetSDK.RUN_CRUISE))
        {
            JOptionPane.showMessageDialog(this, "运行路线失败");
            return;
        }
    ...
    private void jButtonGotoPresetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGotoPresetActionPerformed
        ...
        if (!ClientDemo.hCNetSDK.NET_DVR_PTZPreset(m_lRealHandle, HCNetSDK.GOTO_PRESET, iPreset))
        {
    ...
    private void jButtonSetPresetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSetPresetActionPerformed
        int iPreset = jComboBoxPreset.getSelectedIndex() + 1;
        if (!ClientDemo.hCNetSDK.NET_DVR_PTZPreset(m_lRealHandle, HCNetSDK.SET_PRESET, iPreset))
        {
    ...
    private void jButtonDeletePresetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeletePresetActionPerformed
        int iPreset = jComboBoxPreset.getSelectedIndex() + 1;
        if (!ClientDemo.hCNetSDK.NET_DVR_PTZPreset(m_lRealHandle, HCNetSDK.CLE_PRESET, iPreset))
        {
            JOptionPane.showMessageDialog(this, "设置预置点失败");
            return;
        }
    ...
    private void jButtonGotoSeqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGotoSeqActionPerformed
        ...
        if (!m_bIsOnCruise)
        {
            if (!ClientDemo.hCNetSDK.NET_DVR_PTZCruise(m_lRealHandle, HCNetSDK.RUN_SEQ, iSeq, (byte) 0, (short) 0))
            {
    ...
    {//GEN-HEADEREND:event_jSliderVolumeStateChanged
        ...
        if (ClientDemo.g_lVoiceHandle >= 0)
        {
            ClientDemo.hCNetSDK.NET_DVR_SetVoiceComClientVolume(ClientDemo.g_lVoiceHandle, (short) (m_iVolume * ((0xffff) / 100)));
        }
    ...
    {
        if(!ClientDemo.hCNetSDK.NET_DVR_ClientSetVideoEffect(m_lRealHandle, m_iBrightness, m_iContrast, m_iSaturation, m_iHue))
        {
    ...
    返回值:
     *************************************************/
    private void PTZControlAll(int lRealHandle, int iPTZCommand, int iStop)
    {
        int iSpeed = jComboBoxSpeed.getSelectedIndex();
        if (lRealHandle >= 0)
        {
            ...
            if (iSpeed >= 1)//有速度的ptz
            {
                ret = ClientDemo.hCNetSDK.NET_DVR_PTZControlWithSpeed(lRealHandle, iPTZCommand, iStop, iSpeed);
                if (!ret)
                {
            ...
            {
                ret = ClientDemo.hCNetSDK.NET_DVR_PTZControl(lRealHandle, iPTZCommand, iStop);
                if (!ret)
                {
                    JOptionPane.showMessageDialog(this, "云台控制失败");
                    return;
