...
public interface HCNetSDK extends Library {
    ...
    public static final int STA_MEM_CRUISE = 34;/* 开始记录路线 */
    public static final int STO_MEM_CRUISE = 35;/* 停止记录路线 */
    public static final int RUN_CRUISE = 36;    /* 开始路线 */
...
//智能设备类型
    ...
    public static class NET_DVR_DECODERCFG_V30 extends Structure {//通道解码器(云台)参数配置(9000扩展)
        ...
        public byte[] bySetTrack = new byte[MAX_TRACK_V30];            /* 路线是否设置,0-没有设置,1-设置*/
    ...
    public static class NET_DVR_DECODERCFG extends Structure {//通道解码器(云台)参数配置
        ...
        public byte[] bySetTrack = new byte[MAX_TRACK];            /* 路线是否设置,0-没有设置,1-设置*/
    ...
    public static class NET_DVR_ALARMINCFG_V30 extends Structure {//报警输入参数配置(9000扩展)
        ...
        public byte[] byEnablePtzTrack = new byte[MAX_CHANNUM_V30];        /* 是否调用路线 0-否,1-是*/
        public byte[] byPTZTrack = new byte[MAX_CHANNUM_V30];            /* 调用的云台的路线序号 */
    ...
    public static class NET_DVR_ALARMINCFG extends Structure {//报警输入参数配置
        ...
        public byte[] byEnablePtzTrack = new byte[MAX_CHANNUM];        /* 是否调用路线 0-否,1-是*/
        public byte[] byPTZTrack = new byte[MAX_CHANNUM];            /* 调用的云台的路线序号 */
...
//NET_DVR_Login()参数结构
    ...
    public static class NET_DVR_SETUPALARM_PARAM_V50 extends Structure {
        ...
        //Bit6- 表示雷达检测报警(eventType:radarDetection)是否开启实时上传；0-不开启，1-开启（用于web插件实时显示雷达目标路线）
        public byte bySupport;
        //断网续传类型
...
//入侵参数
    ...
    */
    ...
    public static class NET_DVR_EVENT_TRIGGER extends Structure {
        ...
        public NET_DVR_PTZTRACKCHAN_INFO[] struPtzTrackInfo = new NET_DVR_PTZTRACKCHAN_INFO[MAX_CHANNUM_V40]; //调用云台路线的通道信息
