...
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
     ...
     *************************************************/
    public JDialogBasicConfig(java.awt.Frame parent, boolean modal, int lUserID)
    {
        super(parent, modal);
    ...
    private void initDialog()
    {
        ...
        boolean getDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_GetDVRConfig(m_lUserID, HCNetSDK.NET_DVR_GET_DEVICECFG,
