...
public class JDialogSerialCfg extends javax.swing.JDialog
{
    ...
    private int m_lSerialHandle;//NET_DVR_SerialStart()的返回值 ,串口发送句柄
     ...
     *************************************************/
    public JDialogSerialCfg(java.awt.Frame parent, boolean modal, int lUserID, HCNetSDK.NET_DVR_DEVICEINFO_V30 strDeviceInfo)
    {
        super(parent, modal);
        m_lUserID = lUserID;
    ...
    private void jComboBox485ChannelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox485ChannelActionPerformed
        if (b485Initialed)
        {
            ...
            getDVRConfigSuc = hCNetSDK.NET_DVR_GetDVRConfig(m_lUserID, HCNetSDK.NET_DVR_GET_DECODERCFG_V30,
                    iChannelNumber, lpConfig, m_stru485DecoderCfg.size(), ibrBytesReturned);
    ...
    private void jButtonSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSendActionPerformed
        ...
        if (iSendInterface == 0)
        {
            ...
            if (!hCNetSDK.NET_DVR_SerialSend(m_lSerialHandle, lSerialChan, bMessage, sMessage.length()))
            {
    ...
    private void jButtonCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreateActionPerformed
        ...
        m_lSerialHandle = hCNetSDK.NET_DVR_SerialStart(m_lUserID, iSerialType, fSerialDataCallBack, 0);
        if (m_lSerialHandle == -1)
        {
    ...
    private void initial232()
    {
        ...
        getDVRConfigSuc = hCNetSDK.NET_DVR_GetDVRConfig(m_lUserID, HCNetSDK.NET_DVR_GET_RS232CFG_V30,
                0, lpConfig, m_strRs232Cfg.size(), ibrBytesReturned);
        m_strRs232Cfg.read();
        if (getDVRConfigSuc != true)
        {
