...
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
    ...
    private int lUserID;//用户ID

    /*************************************************
    函数:      JDialogChannelConfig
    函数描述:	构造函数
     *************************************************/
    public JDialogChannelConfig(java.awt.Frame parent, boolean modal, int lUserId, HCNetSDK.NET_DVR_DEVICEINFO_V30 strDeviceInfo)
    {
        super(parent, modal);
    ...
    private void jButtonStringActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonStringActionPerformed
        ...
        boolean getDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_GetDVRConfig(lUserID, HCNetSDK.NET_DVR_GET_SHOWSTRING_V30,
                iChannelNumber, lpStringConfig, m_strShowString.size(), ibrBytesReturned);
    ...
    private void jButtonSetChanConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSetChanConfigActionPerformed
        ...
        boolean setDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_SetDVRConfig(lUserID, HCNetSDK.NET_DVR_SET_PICCFG_V30,
                iChannelNumber, lpPicConfig, m_struPicCfg.size());
        m_struPicCfg.read();
        ...
        setDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_SetDVRConfig(lUserID, HCNetSDK.NET_DVR_SET_COMPRESSCFG_V30,
                iChannelNumber, lpPicConfig, m_struCompressionCfg.size());
        m_struCompressionCfg.read();
        if (setDVRConfigSuc != true)
        {
            JOptionPane.showMessageDialog(this, "设置压缩参数失败");
            System.out.println(ClientDemo.hCNetSDK.NET_DVR_GetLastError());
            return;
        }
        ...
        setDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_SetDVRConfig(lUserID, HCNetSDK.NET_DVR_SET_RECORDCFG_V30,
                iChannelNumber, lpPicConfig, m_struRemoteRecCfg.size());
    ...
    public void showChannelConfig()
    {
        ...
        m_struPicCfg.write();
        Pointer lpPicConfig = m_struPicCfg.getPointer();
        boolean getDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_GetDVRConfig(lUserID, HCNetSDK.NET_DVR_GET_PICCFG_V30,
                iChannelNumber, lpPicConfig, m_struPicCfg.size(), ibrBytesReturned);
        m_struPicCfg.read();
        if (getDVRConfigSuc != true)
        {
        ...
        m_struCompressionCfg.write();
        lpPicConfig = m_struCompressionCfg.getPointer();
        getDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_GetDVRConfig(lUserID, HCNetSDK.NET_DVR_GET_COMPRESSCFG_V30,
                iChannelNumber, lpPicConfig, m_struCompressionCfg.size(), ibrBytesReturned);
        m_struCompressionCfg.read();
        if (getDVRConfigSuc != true)
        {
        ...
        m_struRemoteRecCfg.write();
        lpPicConfig = m_struRemoteRecCfg.getPointer();
        getDVRConfigSuc = ClientDemo.hCNetSDK.NET_DVR_GetDVRConfig(lUserID, HCNetSDK.NET_DVR_GET_RECORDCFG_V30,
                iChannelNumber, lpPicConfig, m_struRemoteRecCfg.size(), ibrBytesReturned);
        m_struRemoteRecCfg.read();
        if (getDVRConfigSuc != true)
        {
            System.out.println(ClientDemo.hCNetSDK.NET_DVR_GetLastError());
