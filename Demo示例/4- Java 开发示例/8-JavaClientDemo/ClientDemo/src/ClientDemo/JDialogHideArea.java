...
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
     ...
     *************************************************/
    public JDialogHideArea(javax.swing.JDialog parent, boolean modal, int lUserID, int iChannelNum, HCNetSDK.NET_DVR_PICCFG_V30 struPicCfg)
    {
        super(parent, modal);
        initComponents();
        m_lUserID = lUserID;
	...
	if (jRadioButtonShowArea.isSelected())
	{
		...
		ClientDemo.hCNetSDK.NET_DVR_RigisterDrawFun(m_lPlayHandle,ShelterAreaGetCallBack, 0);
	}
	else
	{
		ClientDemo.hCNetSDK.NET_DVR_RigisterDrawFun(m_lPlayHandle,null, 0);
       	...
       	if (m_bDrawdetect)
	{
			...
			ClientDemo.hCNetSDK.NET_DVR_RigisterDrawFun(m_lPlayHandle, ShelterAreaSetCallBack, 0);
