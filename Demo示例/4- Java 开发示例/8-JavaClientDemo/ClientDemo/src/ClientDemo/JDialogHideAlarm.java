...
//    static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
     ...
     *************************************************/
    public JDialogHideAlarm(javax.swing.JDialog parent, boolean modal, int lUserID, int iChannelNum, HCNetSDK.NET_DVR_PICCFG_V30 struPicCfg, HCNetSDK.NET_DVR_DEVICEINFO_V30 strDeviceInfo) {
        super(parent, modal);
        initComponents();
   ...
   /*************************************************
    ...
    {//GEN-HEADEREND:event_panelPlayMousePressed
        if (m_bDrawdetect)
        {
            ...
            ClientDemo.hCNetSDK.NET_DVR_RigisterDrawFun(m_lPlayHandle, HideAreaSetCallBack, 0);
            if (point.x < 0)
            {
                point.x = 0;
            }
	...
	if (jCheckBoxGetHideAlarmArea.isSelected())
	{
		...
		ClientDemo.hCNetSDK.NET_DVR_RigisterDrawFun(m_lPlayHandle,HideAreaGetCallBack, 0);
	}
	else
	{
		ClientDemo.hCNetSDK.NET_DVR_RigisterDrawFun(m_lPlayHandle,null, 0);
