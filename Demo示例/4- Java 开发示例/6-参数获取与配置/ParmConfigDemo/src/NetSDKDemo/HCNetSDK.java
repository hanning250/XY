...
public interface HCNetSDK extends Library {
     ...
     */
    public static final int NET_SDK_CALLBACK_TYPE_STATUS = 0;        // 回调状态值
    public static final int NET_SDK_CALLBACK_TYPE_PROGRESS = 1;            // 回调进度值
    public static final int NET_SDK_CALLBACK_TYPE_DATA = 2;               // 回调数据内容

    /**
     * 回调类型为NET_SDK_CALLBACK_TYPE_STATUS时的状态值
     */

    public static final int NET_SDK_CALLBACK_STATUS_SUCCESS = 1000;        // 成功
    public static final int NET_SDK_CALLBACK_STATUS_PROCESSING = 1001;            // 处理中
    public static final int NET_SDK_CALLBACK_STATUS_FAILED = 1002;                // 失败
    public static final int NET_SDK_CALLBACK_STATUS_EXCEPTION = 1003;            // 异常
    public static final int NET_SDK_CALLBACK_STATUS_LANGUAGE_MISMATCH = 1004;    //（IPC配置文件导入）语言不匹配
    public static final int NET_SDK_CALLBACK_STATUS_DEV_TYPE_MISMATCH = 1005;    //（IPC配置文件导入）设备类型不匹配
    public static final int NET_DVR_CALLBACK_STATUS_SEND_WAIT=1006;           // 发送等待
...
//网络(NET_DVR_NETCFG_V30结构)
    ...
    //录像计划参数
    public static final int NET_DVR_GET_RECORDCFG_V40 = 1008;    //获取录像参数
    public static final int NET_DVR_SET_RECORDCFG_V40 = 1009;    //设置录像参数
    ...
    //获取和设置网络参数
    public static final int NET_DVR_GET_NETCFG_V50 = 1015;//获取网络参数
    public static final int NET_DVR_SET_NETCFG_V50 = 1016;//设置网络参数
    ...
    public static final int NET_DVR_GET_WORK_STATUS_V50 = 6200;   //获取设备工作状态V50
...
//智能设备类型
    ...
    //能力获取命令
    public static final int DEVICE_SOFTHARDWARE_ABILITY = 0x001;//设备软硬件能力
    public static final int DEVICE_JPEG_CAP_ABILITY = 0x00f;//设备JPEG抓图能力
...
//        }
    ...
    public static class NET_DVR_ETHERNET_V30 extends Structure {
        ...
        public byte   byEthernetPortNo;//网口号，0-无效，1-网口0，2-网口1以此类推，只读
...
//IPC接入参数配置
    ...
    public static class NET_DVR_TIME_V50 extends Structure{
        ...
        public byte cTimeDifferenceM;   //与UTC的时差（分钟），-30, 0, 30, 45，+表示东区，byISO8601为1时有效
    }

    //日志查找条件结构体
    public static class NET_DVR_FIND_LOG_COND extends Structure{
        public int dwSelectMode;  // 0－全部；1－按类型；2－按时间；3－按时间和类型
        public int dwMainType;	//日志主类型 0-全部 0x1-报警；0x2-异常；0x3-操作；0x4-日志附加信息
        public int dwSubType;		//日志次类型
        public NET_DVR_TIME_V50 struStartTime; //开始时间
        public NET_DVR_TIME_V50 struEndTime;   //结束时间
        public boolean bOnlySmart;    //是否只搜索带S.M.A.R.T信息的日志
        public byte[] byRes =  new byte[128];
    }

    //日志信息结构体
    public static class NET_DVR_LOG_V50 extends Structure{
        public NET_DVR_TIME_V50 struLogTime;    //日志发生的时间
        public int dwMajorType;    //主类型 1-报警; 2-异常; 3-操作; 0xff-全部
        public int dwMinorType;    //次类型 0-全部;
        public byte[] sPanelUser = new byte[MAX_NAMELEN];//操作面板的用户名
        public byte[] sNetUser = new byte[MAX_NAMELEN];//网络操作的用户名
        public NET_DVR_IPADDR struRemoteHostAddr;     //远程主机地址
        public int dwParaType; //参数类型,9000设备MINOR_START_VT/MINOR_STOP_VT时，表示语音对讲的端子号
        public int dwChannel;  //通道号
        public int dwDiskNumber;   //硬盘号
        public int dwAlarmInPort;  //报警输入端口
        public int dwAlarmOutPort; //报警输出端口
...
//辅助输出参数配置
    ...
    public static class NET_DVR_NETCFG_V50 extends Structure {
        public int dwSize;
        public NET_DVR_ETHERNET_V30[] struEtherNet = new NET_DVR_ETHERNET_V30[MAX_ETHERNET];//以太网口
        public NET_DVR_IPADDR[] struRes1 = new NET_DVR_IPADDR[2];/*保留*/
        public NET_DVR_IPADDR struAlarmHostIpAddr;/* 报警主机IP地址 */
        public byte[] byRes2 = new byte[4];/* 保留 */
        public short wAlarmHostIpPort;/* 报警主机端口号 */
        ...
        public byte[]  byIpResolver = new byte[MAX_DOMAIN_NAME];/* IP解析服务器域名或IP地址 */
        public short wIpResolverPort;/* IP解析服务器端口号 */
        public short wHttpPortNo;/* HTTP端口号 */
        public NET_DVR_IPADDR struMulticastIpAddr;                    /* 多播组地址 */
        public NET_DVR_IPADDR struGatewayIpAddr;                        /* 网关地址 */
        public NET_DVR_PPPOECFG struPPPoE;//PPPoE参数
        ...
        public short wAlarmHost2IpPort; /* 报警主机2端口号 */
        public NET_DVR_IPADDR struAlarmHost2IpAddr; /* 报警主机2 IP地址 */
        public byte byEnableDNS; //DNS使能, 0-关闭，1-打开
...
//	public NET_ITC_REDLIGHT_PEDESTRIAN_PARAM struRedLightPed = new NET_ITC_REDLIGHT_PEDESTRIAN_PARAM();//行人闯红灯参数
    ...
    */
    ...
    214-1920*1080@24fps、215-4800*1600@25fps、216-4800*1600@30fps、217-2560*1440@12.5fps、218-6560*3690@1fps、219-5120*1400@20fps*/
        ...
        public byte byRes;
        public short wCaptureModeN;  //视频输入模式（N制），当模式索引小于255时，与byCaptureModeN保持一致，大于255时以该字段返回索引值判断。
        public short wCaptureModeP;  //视频输入模式（P制），当模式索引小于255时，与byCaptureModeN保持一致，大于255时以该字段返回索引值判断
