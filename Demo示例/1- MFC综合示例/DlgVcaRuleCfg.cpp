...
Return:	none
**********************************************************/
void CALLBACK DrawAlertShow(LONG lRealHandle, HDC hDc, void* pUser)
{
    SetBkMode(hDc, TRANSPARENT);
    SetTextColor(hDc, RGB(255, 255, 255));
    if(g_pDlgVcaRuleCfg->m_bRuleActive)
    {
        g_pDlgVcaRuleCfg->F_DrawFun(lRealHandle, hDc, pUser); 
    }
...
Return:	void
**********************************************************/
void CDlgVcaRuleCfg::F_DrawFun(long lPlayHandle, HDC hDc, void* pUser)
{
    COLORREF color;
    ...
    if(	m_struOneRule.wEventTypeEx== ENUM_VCA_EVENT_ENTER_AREA
        ...
        || m_struOneRule.wEventTypeEx == ENUM_VCA_EVENT_FAKECARD
        )
    {
        F_DrawFrame(hDc);
    }
...
//     }NET_VCA_OVER_TIME, *LPNET_VCA_OVER_TIME;
    ...
    case ENUM_VCA_EVENT_FAKECARD:
        ...
        bySensitivity = uEventParam.struFakeCard.bySensitivity;
        break;
    default:
        break;
    }
...
void CDlgVcaRuleCfg::GetEventUnionFromWnd(NET_VCA_EVENT_UNION &uEventParam, DWORD dwEventType)
{
    ...
    case ENUM_VCA_EVENT_FAKECARD:
        ...
        uEventParam.struFakeCard.bySensitivity = (BYTE)(m_comboSensitive.GetCurSel() + 1);
        break;
    default:
        break;
    }
