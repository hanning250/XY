...
void CDlgAlarmHostLogSearch::InitMinorAlarmCombo()
{
    ...
    nIndex++;
	m_comboMinorType.InsertString(nIndex, "MINOR_VIRTUAL_DEFENCE_SUSPECT");
    m_comboMinorType.SetItemData(nIndex, MINOR_VIRTUAL_DEFENCE_SUSPECT);
    nIndex++;
...
void CDlgAlarmHostLogSearch::InitMinorOperatorCombo()
{
    ...
    m_comboMinorType.InsertString(nIndex, "MINOR_ALARMHOST_FACESNAP_CFG");//目标抓拍配置
...
void CDlgAlarmHostLogSearch::InfoMinorAlarmMap(DWORD dwMinorType, CString &szTemp)
{
	...
	case MINOR_URGENCYBTN_OFF:			//紧急按钮复位
		...
		break;
    case MINOR_VIRTUAL_DEFENCE_SUSPECT:			//软防区匪警
		g_StringLanType(szLan, "软防区匪警", "VIRTUAL_DEFENCE_SUSPECT");
		break;
...
void CDlgAlarmHostLogSearch::InfoMinorOperationMap(DWORD dwMinorType, CString &szTemp)
{
    ...
    case MINOR_ALARMHOST_FACESNAP_CFG:
        g_StringLanType(szLan, "目标抓拍配置", "MINOR_ALARMHOST_FACESNAP_CFG");
        break;
