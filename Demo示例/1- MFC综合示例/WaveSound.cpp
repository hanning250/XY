...
void CALLBACK CWaveSound::waveOutProc(HWAVEOUT hwo, UINT uMsg, void *pInstance, void *pParam1, void *pParam2)
{
    CWaveSound*pOwner = (CWaveSound*)pInstance;
    LPWAVEHDR lpWaveHdr = (LPWAVEHDR)pParam1;
	switch (uMsg)
	{
		case WOM_DONE:
...
BOOL CWaveSound::InputData(PBYTE pBuf,void* pUser)
{
	if (!m_bOpenSound)
	{
		return FALSE;
	...
	m_pWaveHead[nSequenceCount].dwUser = (DWORD)(LONG_PTR)pUser;
