...
void CDlgInfoDiffusionXmlCfg::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Text(pDX, IDC_EDIT_SECONDARY_AUTH_PWD, m_strSecondaryAuthPwd);
}
...
void CDlgInfoDiffusionXmlCfg::TransferFormData()
{
	...
	if (m_strSecondaryAuthPwd.GetLength() > 0)
	{
		struInputParam.sPassword = m_strSecondaryAuthPwd.GetBuffer(0);
	}
