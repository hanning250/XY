...
void CALLBACK g_DrawTempRgn(LONG lRealHandle, HDC hDc, void* pUser)
{
    CDlgThermometry* pDlg = (CDlgThermometry*)pUser;
...
BOOL CDlgThermometry::StartRealPlay()
{
    ...
    else
    {
        ...
        bRet = NET_DVR_RigisterDrawFunEx(m_lRealHandle, g_DrawTempRgn, this);//DC Draw callback
    }
    return bRet;
}
