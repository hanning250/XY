...
void CDlgVcaVersionList::AddVcaVersionListItem(const NET_DVR_VCA_VERSION_LIST &Item)
{
    ...
    for (i = 0; i < 64; i++)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            sprintf(szStr, "%s", "异常行为检测");
            break;
        case 3:
            sprintf(szStr, "%s", "人体属性");
            break;
        case 4:
            sprintf(szStr, "%s", "目标抓拍");
            break;
        case 5:
            sprintf(szStr, "%s", "人脸采集");
            break;
        case 6:
        ...
        case 15:
            ...
            break;
        case 16:
            sprintf(szStr, "%s", "人数异常");
            break;
        case 17:
            sprintf(szStr, "%s", "离岗检测");
            break;
        case 18:
            sprintf(szStr, "%s", "人员滞留");
            break;
        case 19:
            sprintf(szStr, "%s", "目标抓拍建模");
            break;
        case 20:
            sprintf(szStr, "%s", "HMS建模");
            break;
        case 21:
            sprintf(szStr, "%s", "态势分析");
            break;
        case 22:
            sprintf(szStr, "%s", "城管算法");
            break;
        case 23:
            sprintf(szStr, "%s", "排队检测");
            break;
        default:
            break;
        }
