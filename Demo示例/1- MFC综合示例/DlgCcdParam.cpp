...
void CDlgCcdParam::OnBtnGetEx() 
{
    ...
    if (m_CcdParamEx.byCaptureModeP < 255) //当输入P模式小于255时
    {
...
void CDlgCcdParam::OnBtnSetEx() 
{
    ...
    int iCaptureModeN = m_comboCaptureMode.GetCurSel();
    if (iCaptureModeN < 255) //当输入N模式小于255时
    {
        m_CcdParamEx.byCaptureModeN = iCaptureModeN;
    }
    else //当输入模式大于255时
    {
        m_CcdParamEx.byCaptureModeN = 255;
        m_CcdParamEx.wCaptureModeN = iCaptureModeN;
    }

    int iCaptureModeP = m_comboCaptureMode2.GetCurSel();
    if (iCaptureModeP < 255) //当输入P模式小于255时
    {
        m_CcdParamEx.byCaptureModeP = iCaptureModeP;
    }
    else //当输入模式大于255时
    {
        m_CcdParamEx.byCaptureModeP = 255;
        m_CcdParamEx.wCaptureModeP = iCaptureModeP;
    }
...
{
    InsertCaptureMode(&m_comboCaptureMode);
}

void  CDlgCcdParam::AddCaptureModeP()
{
    InsertCaptureMode(&m_comboCaptureMode2);
}

void CDlgCcdParam::InsertCaptureMode(CComboBox* pComBox)
{
    int index = 0;
    pComBox->InsertString(index++, "0-close");
    pComBox->InsertString(index++, "1-640*480@25fps");
    pComBox->InsertString(index++, "2-640*480@30ps");
    pComBox->InsertString(index++, "3-704*576@25fps");
    pComBox->InsertString(index++, "4-704*480@30fps");
    pComBox->InsertString(index++, "5-1280*720@25fps");
    pComBox->InsertString(index++, "6-1280*720@30fps");
    pComBox->InsertString(index++, "7-1280*720@50fps");
    pComBox->InsertString(index++, "8-1280*720@60fps");
    pComBox->InsertString(index++, "9-1280*960@15fps");
    pComBox->InsertString(index++, "10-1280*960@25fps");
    pComBox->InsertString(index++, "11-1280*960@30fps");
    pComBox->InsertString(index++, "12-1280*1024@25fps");
    pComBox->InsertString(index++, "13-1280*1024@30fps");
    pComBox->InsertString(index++, "14-1600*900@15fps");
    pComBox->InsertString(index++, "15-1600*1200@15fps");
    pComBox->InsertString(index++, "16-1920*1080@15fps");
    pComBox->InsertString(index++, "17-1920*1080@25fps");
    pComBox->InsertString(index++, "18-1920*1080@30fps");
    pComBox->InsertString(index++, "19-1920*1080@50fps");
    pComBox->InsertString(index++, "20-1920*1080@60fps");
    pComBox->InsertString(index++, "21-2048*1536@15fps");
    pComBox->InsertString(index++, "22-2048*1536@20fps");
    pComBox->InsertString(index++, "23-2048*1536@24fps");
    pComBox->InsertString(index++, "24-2048*1536@25fps");
    pComBox->InsertString(index++, "25-2048*1536@30fps");
    pComBox->InsertString(index++, "26-2560*2048@25fps");
    pComBox->InsertString(index++, "27-2560*2048@30fps");
    pComBox->InsertString(index++, "28-2560*1920@7.5fps");
    pComBox->InsertString(index++, "29-3072*2048@25fps");
    pComBox->InsertString(index++, "30-3072*2048@30fps");
    pComBox->InsertString(index++, "31-2048*1536@12.5");
    pComBox->InsertString(index++, "32-2560*1920@6.25");
    pComBox->InsertString(index++, "33-1600*1200@25");
    pComBox->InsertString(index++, "34-1600*1200@30");
    pComBox->InsertString(index++, "35-1600*1200@12.5");
    pComBox->InsertString(index++, "36-1600*900@12.5");
    pComBox->InsertString(index++, "37-1280*960@12.5fps");
    pComBox->InsertString(index++, "38-800*600@25fps");
    pComBox->InsertString(index++, "39-800*600@30fps40");
    pComBox->InsertString(index++, "40-4000*3000@12.5fps");
    pComBox->InsertString(index++, "41-4000*3000@15fps");
    pComBox->InsertString(index++, "42-4096*2160@20fps");
    pComBox->InsertString(index++, "43-3840*2160@20fps");
    pComBox->InsertString(index++, "44-960*576@25fps");
    pComBox->InsertString(index++, "45-960*480@30fps");
    pComBox->InsertString(index++, "46-752*582@25fps");
    pComBox->InsertString(index++, "47-768*494@30fps");
    pComBox->InsertString(index++, "48-2560*1440@25fps");
    pComBox->InsertString(index++, "49-2560*1440@30fps");
    pComBox->InsertString(index++, "50-720P@100fps");
    pComBox->InsertString(index++, "51-720P@120fps");
    pComBox->InsertString(index++, "52-2048*1536@50fps8");
    pComBox->InsertString(index++, "53-2048*1536@60fps");
    pComBox->InsertString(index++, "54-3840*2160@25fps");
    pComBox->InsertString(index++, "55-3840*2160@30fps");
    pComBox->InsertString(index++, "56-4096*2160@25fps");
    pComBox->InsertString(index++, "57-4096*2160@30fps)");
    pComBox->InsertString(index++, "58-1280*1024@50fps");
    pComBox->InsertString(index++, "59-1280*1024@60fps");
    pComBox->InsertString(index++, "60-3072*2048@50fps");
    pComBox->InsertString(index++, "61-3072*2048@60fps");
    pComBox->InsertString(index++, "62-3072*1728@25fps");
    pComBox->InsertString(index++, "63-3072*1728@30fps");
    pComBox->InsertString(index++, "64-3072*1728@50fps0");
    pComBox->InsertString(index++, "65-3072*1728@60fps");
    pComBox->InsertString(index++, "66-336*256@50fps");
    pComBox->InsertString(index++, "67-336*256@60fps");
    pComBox->InsertString(index++, "68-384*288@50fps");
    pComBox->InsertString(index++, "69-384*288@60fps");
    pComBox->InsertString(index++, "70-640*512@50fps");
    pComBox->InsertString(index++, "71-640*512@60fps");
    pComBox->InsertString(index++, "72-2592*1944@25fps");
    pComBox->InsertString(index++, "73-2592*1944@30fps");
    pComBox->InsertString(index++, "74-2688*1536@25fps");
    pComBox->InsertString(index++, "75-2688*1536@30fps");
    pComBox->InsertString(index++, "76-2592*1944@20fps");
    pComBox->InsertString(index++, "77-2592*1944@15fps");
    pComBox->InsertString(index++, "78-2688*1520@20fps");
    pComBox->InsertString(index++, "79-2688*1520@15fps");
    pComBox->InsertString(index++, "80-2688*1520@25fps");
    pComBox->InsertString(index++, "81-2688*1520@30fps");
    pComBox->InsertString(index++, "82-2720*2048@25fps");
    pComBox->InsertString(index++, "83-2720*2048@30fps");
    pComBox->InsertString(index++, "84-336*256@25fps");
    pComBox->InsertString(index++, "85-384*288@25fps");
    pComBox->InsertString(index++, "86-640*512@25fps");
    pComBox->InsertString(index++, "87-1280*960@50fps");
    pComBox->InsertString(index++, "88-1280*960@60fps");
    pComBox->InsertString(index++, "89-1280*960@100fps");
    pComBox->InsertString(index++, "90-1280*960@120fps");
    pComBox->InsertString(index++, "91-4000*3000@20fps");
    pComBox->InsertString(index++, "92-1920*1200@25fps");
    pComBox->InsertString(index++, "93-1920*1200@30fps");
    pComBox->InsertString(index++, "94-2560*1920@25fps");
    pComBox->InsertString(index++, "95-2560*1920@20fps");
    pComBox->InsertString(index++, "96-2560*1920@30fps");
    pComBox->InsertString(index++, "97-1280*1920@25fps");
    pComBox->InsertString(index++, "98-1280*1920@30fps");
    pComBox->InsertString(index++, "99-4000*3000@24fps");
    pComBox->InsertString(index++, "100-4000*3000@25fps");
    pComBox->InsertString(index++, "101-4000*3000@10fps");
    pComBox->InsertString(index++, "102-384*288@30fps");
    pComBox->InsertString(index++, "103-2560*1920@15fps");
    pComBox->InsertString(index++, "104-2400*3840@25fps");
    pComBox->InsertString(index++, "105-1200*1920@25fps8");
    pComBox->InsertString(index++, "106-4096*1800@30fps");
    pComBox->InsertString(index++, "107-3840*1680@30fps");
    pComBox->InsertString(index++, "108-2560*1120@30fps");
    pComBox->InsertString(index++, "109-704*320@30fps");
    pComBox->InsertString(index++, "110-1280*560@30fps");
    pComBox->InsertString(index++, "111-4096*1800@25fps");
    pComBox->InsertString(index++, "112-3840*1680@25fps");
    pComBox->InsertString(index++, "113-2560*1120@25fps");
    pComBox->InsertString(index++, "114-704*320@25fps");
    pComBox->InsertString(index++, "115-1280*560@25fps");
    pComBox->InsertString(index++, "116-2400*3840@24fps");
    pComBox->InsertString(index++, "117-3840*2400@24fps");
    pComBox->InsertString(index++, "118-3840*2400@25fps");
    pComBox->InsertString(index++, "119-2560*1920@12.5fps");
    pComBox->InsertString(index++, "120-2560*2048@12fps");
    pComBox->InsertString(index++, "121-2560*2048@15fps");
    pComBox->InsertString(index++, "122-2560*1536@25fps");
    pComBox->InsertString(index++, "123-2560*1536@30fps");
    pComBox->InsertString(index++, "124-2256*2048@25fps");
    pComBox->InsertString(index++, "125-2256*2048@30fps");
    pComBox->InsertString(index++, "126-2592*2592@12.5fps");
    pComBox->InsertString(index++, "127-2592*2592@15fps");
    pComBox->InsertString(index++, "128-640*512@30fps");
    pComBox->InsertString(index++, "129-2048*1520@30fps");
    pComBox->InsertString(index++, "130-2048*1520@25fps");
    pComBox->InsertString(index++, "131-3840*2160@24fps");
    pComBox->InsertString(index++, "132-2592*1520@25fps");
    pComBox->InsertString(index++, "133-2592*1520@30fps");
    pComBox->InsertString(index++, "134-2592*1536@25fps");
    pComBox->InsertString(index++, "135-2592*1536@30fps");
    pComBox->InsertString(index++, "136-640*960@25fps");
    pComBox->InsertString(index++, "137-640*960@24fps");
    pComBox->InsertString(index++, "138-undefined");
    pComBox->InsertString(index++, "139-3840*1080@25fps");
    pComBox->InsertString(index++, "140-3840*1080@30fps");
    pComBox->InsertString(index++, "141-2688*1520@12.5fps");
    pComBox->InsertString(index++, "142-2992*2192@25fps");
    pComBox->InsertString(index++, "143-2992*2192@30fps");
    pComBox->InsertString(index++, "144-3008*2160@25fps");
    pComBox->InsertString(index++, "145-3008*2160@30fps");
    pComBox->InsertString(index++, "146-3072*1728@20fps");
    pComBox->InsertString(index++, "147-2560*1440@20fps");
    pComBox->InsertString(index++, "148-2160*3840@25fps");
    pComBox->InsertString(index++, "149-2160*3840@30fps");
    pComBox->InsertString(index++, "150-7008*1080@25fps");
    pComBox->InsertString(index++, "151-7008*1080@30fps");
    pComBox->InsertString(index++, "152-3072*2048@20fps");
    pComBox->InsertString(index++, "153-1536*864@25fps");
    pComBox->InsertString(index++, "154-2560*1920@24fps");
    pComBox->InsertString(index++, "155-2400*3840@30fps");
    pComBox->InsertString(index++, "156-3840*2400@30fps");
    pComBox->InsertString(index++, "157-3840*2160@15fps");
    pComBox->InsertString(index++, "158-384*288@8.3fps");
    pComBox->InsertString(index++, "159-640*512@8.3fps");
    pComBox->InsertString(index++, "160-160*120@8.3fps");
    pComBox->InsertString(index++, "161-1024*768@8.3fps");
    pComBox->InsertString(index++, "162-640*480@8.3fps");
    pComBox->InsertString(index++, "163-3840*2160@12.5fps");
    pComBox->InsertString(index++, "164-2304*1296@30fps");
    pComBox->InsertString(index++, "165-2304*1296@25fps");
    pComBox->InsertString(index++, "166-2560*1440@24fps");
    pComBox->InsertString(index++, "167-2688*1512@25fps");
    pComBox->InsertString(index++, "168-2688*1512@30fps");
    pComBox->InsertString(index++, "169-2688*1512@50fps");
    pComBox->InsertString(index++, "170-2688*1512@60fps");
    pComBox->InsertString(index++, "171-1536*864@30fps");
    pComBox->InsertString(index++, "172-2560*1440@50fps");
    pComBox->InsertString(index++, "173-2560*1440@60fps");
    pComBox->InsertString(index++, "174-2048*2048@25fps");
    pComBox->InsertString(index++, "175-2048*2048@30fps");
    pComBox->InsertString(index++, "176-4000*3060@20fps");
    pComBox->InsertString(index++, "177-3060*3060@25fps");
    pComBox->InsertString(index++, "178-3060*3060@30fps");
    pComBox->InsertString(index++, "179-3000*3000@25fps");
    pComBox->InsertString(index++, "180-3000*3000@30fps");
    pComBox->InsertString(index++, "181-8160*3616@30fps");
    pComBox->InsertString(index++, "182-8160*3616@25fps");
    pComBox->InsertString(index++, "183-3000*3000@20fps");
    pComBox->InsertString(index++, "184-3000*3000@15fps");
    pComBox->InsertString(index++, "185-3000*3000@12.5fps2");
    pComBox->InsertString(index++, "186-5472*3648@25fps");
    pComBox->InsertString(index++, "187-5472*3648@30fps");
    pComBox->InsertString(index++, "188-7680*4320@25fps");
    pComBox->InsertString(index++, "189-7680*4320@30fps");
    pComBox->InsertString(index++, "190-8160*2400@25fps");
    pComBox->InsertString(index++, "191-8160*2400@30fps");
    pComBox->InsertString(index++, "192-5520*2400@25fps");
    pComBox->InsertString(index++, "193-5520*2400@30fps");
    pComBox->InsertString(index++, "194-2560*1440@15fps");
    pComBox->InsertString(index++, "195-1944*1212@24fps");
    pComBox->InsertString(index++, "196-1944*1212@25fps");
    pComBox->InsertString(index++, "197-3456*1920@30fps");
    pComBox->InsertString(index++, "198-4800*2688@25fps");
    pComBox->InsertString(index++, "199-4800*2688@30fps");
    pComBox->InsertString(index++, "200-6480*1080@25fps");
    pComBox->InsertString(index++, "201-6480*1080@30fps");
    pComBox->InsertString(index++, "202-8640*1440@25fps");
    pComBox->InsertString(index++, "203-8640*1440@25fps");
    pComBox->InsertString(index++, "204-3456*1920@25fps");
    pComBox->InsertString(index++, "205-2688*1520@50fps");
    pComBox->InsertString(index++, "206-2688*1520@60fps");
    pComBox->InsertString(index++, "207-4976*1452@25fps");
    pComBox->InsertString(index++, "208-4976*1452@30fps");
    pComBox->InsertString(index++, "209-3200*1800@25fps");
    pComBox->InsertString(index++, "210-3200*1800@30fps");
    pComBox->InsertString(index++, "211-5472*3648@24fps");
    pComBox->InsertString(index++, "212-1920*1080@12.5fps");
    pComBox->InsertString(index++, "213-2944*1656@20fps");
    pComBox->InsertString(index++, "214-1920*1080@24fps");
    pComBox->InsertString(index++, "215-4800*1600@25fps");
    pComBox->InsertString(index++, "216-4800*1600@30fps");
    pComBox->InsertString(index++, "217-2560*1440@12.5fps");
    pComBox->InsertString(index++, "218-6560*3690@1fps");
    pComBox->InsertString(index++, "219-5120*1400@20fps2");
    pComBox->InsertString(index++, "220-7680*4320@1fps");
    pComBox->InsertString(index++, "221-1920*1080@20fps");
    pComBox->InsertString(index++, "222-5120*1440@20fps");
    pComBox->InsertString(index++, "223-4080*1808@25fps");
    pComBox->InsertString(index++, "224-4080*1808@30fps");
    pComBox->InsertString(index++, "225-4080*1152@25fps");
    pComBox->InsertString(index++, "226-4080*1152@30fps");
    pComBox->InsertString(index++, "227-2688*1944@20fps");
    pComBox->InsertString(index++, "228-2592*1944@24fps");
    pComBox->InsertString(index++, "229-3200*1800@15fps");
    pComBox->InsertString(index++, "230-4416*1696@20fps");
    pComBox->InsertString(index++, "231-3456*1080@25fps");
    pComBox->InsertString(index++, "232-3200*1800@12.5fps");
    pComBox->InsertString(index++, "233-2688*1532@25fps");
    pComBox->InsertString(index++, "234-2688*1532@30fps");
    pComBox->InsertString(index++, "235-4416*1696@12.5fps");
    pComBox->InsertString(index++, "236-3840*2048P12.5fps");
    pComBox->InsertString(index++, "237-3840*4096P12.5fps");
    pComBox->InsertString(index++, "238-5120*1440@12.5fps");
    pComBox->InsertString(index++, "239-3840*1080@24fps");
    pComBox->InsertString(index++, "240-320*256@30fps");
    pComBox->InsertString(index++, "241-3264*2448@25fps");
    pComBox->InsertString(index++, "242-3264*2448@30fps");
    pComBox->InsertString(index++, "243-5430*3054@1fps");
    pComBox->InsertString(index++, "244-2688*1520@24@24fps");
    pComBox->InsertString(index++, "245-4000*3000@30fps");
    pComBox->InsertString(index++, "246-1632*1224@25fps");
    pComBox->InsertString(index++, "247-1632*1224@30fps");
    pComBox->InsertString(index++, "248-160*120@25fps");
    pComBox->InsertString(index++, "249-1920*1440@25fps");
    pComBox->InsertString(index++, "250-1920*1440@30fps");
    pComBox->InsertString(index++, "251-3632*1632@20fps");
    pComBox->InsertString(index++, "252-3040*1368@25fps");
    pComBox->InsertString(index++, "253-3040*1368@24fps");
    pComBox->InsertString(index++, "254-5120*1440@25fps");
    pComBox->InsertString(index++, "255-undefined");
    pComBox->InsertString(index++, "256-160*120@50fps");
    pComBox->InsertString(index++, "257-3200*1800@20fps");
    pComBox->InsertString(index++, "258-800*480@25fps");
    pComBox->InsertString(index++, "259-2688*1944@25fps");
    pComBox->InsertString(index++, "260-640*384@50fps");
    pComBox->InsertString(index++, "261-8000*6000@1fps");
    pComBox->InsertString(index++, "262-1440*1080@50fps");
    pComBox->InsertString(index++, "263-1440*1080@60fps");
    pComBox->InsertString(index++, "264-8160X3616@24fps");
    pComBox->InsertString(index++, "265-3632*1632@25fps");
    pComBox->InsertString(index++, "266-3632*1632@30fps");
    pComBox->InsertString(index++, "267-3632*1632@20fps");
    pComBox->InsertString(index++, "268-1760*1320@25fps");
    pComBox->InsertString(index++, "269-4000*3000@4fps");
    pComBox->InsertString(index++, "270-192*256@25fps");
    pComBox->InsertString(index++, "271-720*576@25fps");
    pComBox->InsertString(index++, "272-720x576@30fps");
    pComBox->InsertString(index++, "273-960*432@25fps");
    pComBox->InsertString(index++, "274-960*432@30fps");
    pComBox->InsertString(index++, "275-1200*536@25fps");
    pComBox->InsertString(index++, "276-1200*536@30fps");
    pComBox->InsertString(index++, "277-1760*1320@12.5fps");
    pComBox->InsertString(index++, "278-2560*480@25fps");
    pComBox->InsertString(index++, "279-2048*384@25fps");
    pComBox->InsertString(index++, "280-96*96@25fps");
    pComBox->InsertString(index++, "281-320*256@25fps");
    pComBox->InsertString(index++, "282-6128*1800@25fps");
    pComBox->InsertString(index++, "283-6128*1800@30fps");
    pComBox->InsertString(index++, "284-2304*1296@24fps");
    pComBox->InsertString(index++, "285-2048*1152@25fps");
    pComBox->InsertString(index++, "286-2048*1152@30fps");
    pComBox->InsertString(index++, "287-3840*2100@20fps");
    pComBox->InsertString(index++, "288-96*72@25fps");
    pComBox->InsertString(index++, "289-2048*1152@24fps");
    pComBox->InsertString(index++, "290-720*576@50fps");
    pComBox->InsertString(index++, "291-2368*1776@25fps");
    pComBox->InsertString(index++, "292-2368*1776@30fps");
    pComBox->InsertString(index++, "293-1776*1776@25fps");
    pComBox->InsertString(index++, "294-3776*2832@25fps");
    pComBox->InsertString(index++, "295-3776*2832@30fps");
    pComBox->InsertString(index++, "296-2832*2832@25ps");
    pComBox->InsertString(index++, "297-2832*2832@30fps");
    pComBox->InsertString(index++, "298-1776*1776@30fps");
    pComBox->InsertString(index++, "299-1920*1080@100fps");
    pComBox->InsertString(index++, "300-1920*1080@120fps");
    pComBox->InsertString(index++, "301-4096*1800@24fps");
    pComBox->InsertString(index++, "302-8160*2400@24fps");
    pComBox->InsertString(index++, "303-4032*3024@25fps");
    pComBox->InsertString(index++, "304-4032*3024@30fps");
    pComBox->InsertString(index++, "305-3024*3024@25fps");
    pComBox->InsertString(index++, "306-3024*3024@30fps");
    pComBox->InsertString(index++, "307-1686*948@25fps");
    pComBox->InsertString(index++, "308-3200*1800@24fps");
    pComBox->InsertString(index++, "309-3040*5376@25fps");
    pComBox->InsertString(index++, "310-3040*5376@30fps");
    pComBox->InsertString(index++, "311-1520*2688@25fps");
    pComBox->InsertString(index++, "312-1520*2688@30fps");
    pComBox->InsertString(index++, "313-3840*2160@50fps");
    pComBox->InsertString(index++, "314-3840*2160@60fps");
    pComBox->InsertString(index++, "315-5040*2160@25fps");
    pComBox->InsertString(index++, "316-5040*2160@33.3fps");
    pComBox->InsertString(index++, "317-5040*2160@30fps");
    pComBox->InsertString(index++, "318-5040*2160@24fps");
    pComBox->InsertString(index++, "319-5040*2160@40fps");
    pComBox->InsertString(index++, "320-7520*2160@25fps");
    pComBox->InsertString(index++, "321-7520*2160@24fps");
    pComBox->InsertString(index++, "322-7520*2160@30fps");
    pComBox->InsertString(index++, "323-7072*2160@25fps");
    pComBox->InsertString(index++, "324-7072*2160@33.3fps");
    pComBox->InsertString(index++, "325-7072*2160@24fps");
    pComBox->InsertString(index++, "326-7072*2160@30fps");
    pComBox->InsertString(index++, "327-4208*3120@25fp");
    pComBox->InsertString(index++, "328-4208*3120@30fps");
    pComBox->InsertString(index++, "329-5376*3040@25fps");
    pComBox->InsertString(index++, "330-5376*3040@30fps");
    pComBox->InsertString(index++, "331-1440*1440@25fps");
    pComBox->InsertString(index++, "332-1440*1440@30fps");
    pComBox->InsertString(index++, "333-2304*1296@15fps");
    pComBox->InsertString(index++, "334-5336*2246@25fps");
    pComBox->InsertString(index++, "335-5336*2246@30fps");
    pComBox->InsertString(index++, "336-5120*1440@30fps");
    pComBox->InsertString(index++, "337-7680*3840@25fps");
    pComBox->InsertString(index++, "338-7680*3840@30fps");
    pComBox->InsertString(index++, "339-2304*1296@12.5fps");
    pComBox->InsertString(index++, "340-8160*3616@20fps");
    pComBox->InsertString(index++, "341-1920*1632@25fps");
    pComBox->InsertString(index++, "342-1920*1632@30fps");
    pComBox->InsertString(index++, "343-11040*2400@25fps");
    pComBox->InsertString(index++, "344-11040*2400@30fps");
    pComBox->InsertString(index++, "345-8192*1920@25fps");
    pComBox->InsertString(index++, "346-8192*1920@30fps");
    pComBox->InsertString(index++, "347-6192*1344@25fps");
    pComBox->InsertString(index++, "348-6192*1344@30fps");
    pComBox->InsertString(index++, "349-5336*2246@24fps");
    pComBox->InsertString(index++, "350-3632*1632@12.5fps");
    pComBox->InsertString(index++, "351-3632*1632@15fps");
    pComBox->InsertString(index++, "352-11040*3616@10fps");
    pComBox->InsertString(index++, "353-2304*1296@20fps");
    pComBox->InsertString(index++, "354-4256*1888@20fps");
    pComBox->InsertString(index++, "355-5760*2880@25fps");
    pComBox->InsertString(index++, "356-5760*2880@30fps");
    pComBox->InsertString(index++, "357-5760*1280@25fps");
    pComBox->InsertString(index++, "358-5760*1280@30fps");
    pComBox->InsertString(index++, "359-4656*3496@6.25fps");
    pComBox->InsertString(index++, "360-8288*1800@25fps");
    pComBox->InsertString(index++, "361-8288*1800@30fps");
    pComBox->InsertString(index++, "362-6080*1320@25fps");
    pComBox->InsertString(index++, "363-6080*1320@30fps");
    pComBox->InsertString(index++, "364-11040*3616@12.5fps");
    pComBox->InsertString(index++, "365-4800*2688@50fps");
    pComBox->InsertString(index++, "366-4800*2688@60fps");
    pComBox->InsertString(index++, "367-2480*2160@25fps");
    pComBox->InsertString(index++, "368-2480*2160@30fps");
    pComBox->InsertString(index++, "369-8304*1800@25fps");
    pComBox->InsertString(index++, "370-8304*1800@30fps");
    pComBox->InsertString(index++, "371-11040*2400@24fps");
    pComBox->InsertString(index++, "372-8304x1800@24fps");
    pComBox->InsertString(index++, "373-6096x1320@24fps");
    pComBox->InsertString(index++, "374-6096*1320@25fps");
    pComBox->InsertString(index++, "375-6096*1320@30fps");
    pComBox->InsertString(index++, "376-400*300@25fps");
    pComBox->InsertString(index++, "377-2560*2160@25fps");
    pComBox->InsertString(index++, "378-2560*2160@30fps");
    pComBox->InsertString(index++, "379-4608*2592@25fps");
    pComBox->InsertString(index++, "380-4608*2592@30fps");
    pComBox->InsertString(index++, "381-4608*2592@24fps");
    pComBox->InsertString(index++, "382-3840*2160@45fps");
    pComBox->InsertString(index++, "383-7680*4320@24fps");
    pComBox->InsertString(index++, "384-9024*2656@12.5fps");
    pComBox->InsertString(index++, "385-4272*1880@25fps");
    pComBox->InsertString(index++, "386-4272*1880@30fps");
    pComBox->InsertString(index++, "387-6432*1888@25fps");
    pComBox->InsertString(index++, "388-6432*1888@30fps");
    pComBox->InsertString(index++, "389-6816*3840@25fps");
    pComBox->InsertString(index++, "390-6816*3840@24fps");
    pComBox->InsertString(index++, "391-4096*2160@24fps");
    pComBox->InsertString(index++, "392-8160*1800@25fps");
    pComBox->InsertString(index++, "393-8160*1800@30fps");
    pComBox->InsertString(index++, "394-2560*1440@75fps");
    pComBox->InsertString(index++, "395-2560*1440@90fps");
    pComBox->InsertString(index++, "396-7680*3840@24fps");
    pComBox->InsertString(index++, "397-2960*1664@20fps");
    pComBox->InsertString(index++, "398-3840*2160@16.67fps");
    pComBox->InsertString(index++, "399-4608*3456@15fps");
    pComBox->InsertString(index++, "400-4608*2592@20fps");
    pComBox->InsertString(index++, "401-3840*2160@10fps");
    pComBox->InsertString(index++, "402-1920*1080@10fps");
    pComBox->InsertString(index++, "403-8160*1800@24fps");
    pComBox->InsertString(index++, "404-1600*1200@50fps");
    pComBox->InsertString(index++, "405-1600*1200@60fps");
    pComBox->InsertString(index++, "406-1600*1200@100fps");
    pComBox->InsertString(index++, "407-1600*1200@120fps");
    pComBox->InsertString(index++, "408-1600*1200@200fps");
    pComBox->InsertString(index++, "409-1600*1200@210fps");
    pComBox->InsertString(index++, "410-2880*1616@25fps");
    pComBox->InsertString(index++, "411-2880*1616@30fps");
    pComBox->InsertString(index++, "412-5760*3232@20fps");
    pComBox->InsertString(index++, "413-2304*1296@16.67fps");
    pComBox->InsertString(index++, "414-2560*1440@10fps");
    pComBox->InsertString(index++, "415-2160*2160@25fps");
    pComBox->InsertString(index++, "416-2160*2160@30fps");
    pComBox->InsertString(index++, "417-1920*1080@150fps");
    pComBox->InsertString(index++, "418-1920*1080@180fps");
    pComBox->InsertString(index++, "419-2560*1440@100fps");
    pComBox->InsertString(index++, "420-2560*1440@120fps");
    pComBox->InsertString(index++, "421-2880*1616@20fps");
	pComBox->InsertString(index++, "422-3632*1632@24fps");
    pComBox->InsertString(index++, "423-2304*1296@10fps");
    pComBox->InsertString(index++, "424-2560*1440@10fps");
    pComBox->InsertString(index++, "425-3840*2160@10fps");
    pComBox->InsertString(index++, "427-2688*2248@25fps");
    pComBox->InsertString(index++, "428-2688*2248@30fps");
    pComBox->InsertString(index++, "429-3008*1328@20fps");
    pComBox->InsertString(index++, "430-4608*3456@12.5fps");
    pComBox->InsertString(index++, "431-7104*4096@25fps");
    pComBox->InsertString(index++, "432-7104*4096@30fps");
	pComBox->InsertString(index++, "433-1600*1200@150fps");
	pComBox->InsertString(index++, "434-4608*3456@25fps");
	pComBox->InsertString(index++, "435-4608*3456@30fps");
    pComBox->InsertString(index++, "451-5200*2320@20fps");
    pComBox->InsertString(index++, "452-5968*2688@12.5fps");
    pComBox->InsertString(index++, "453-5968*2688@15fps");
    pComBox->InsertString(index++, "454-2576*1456@25fps");
    pComBox->InsertString(index++, "455-2576*1456@30fps");
    pComBox->InsertString(index++, "457-3840*2160@48fps");
    pComBox->InsertString(index++, "458-11040*2400@20fps");
    pComBox->InsertString(index++, "459-11040*2400@15fps");
    pComBox->InsertString(index++, "460-3392*3392@20fps");
    pComBox->InsertString(index++, "461-3392*3392@25fps");
    pComBox->InsertString(index++, "462-3392*3392@30fps");
    pComBox->InsertString(index++, "463-3024*3024@20fps");
    pComBox->InsertString(index++, "464-640*392@100fps");
    pComBox->InsertString(index++, "465-4608*3456@6.25fps");
    pComBox->InsertString(index++, "466-3040*3040@24fps");
    pComBox->InsertString(index++, "467-3040*3040@25fps");
    pComBox->InsertString(index++, "468-3040*3040@30fps");
    pComBox->InsertString(index++, "469-2304*1728@25fps");
    pComBox->InsertString(index++, "470-2304*1728@30fps");
    pComBox->InsertString(index++, "475-1920*1632@20fps");
}
