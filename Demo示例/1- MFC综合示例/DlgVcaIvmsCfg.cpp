...
/*********************************************************
  ...
  Return:	void
**********************************************************/
void CALLBACK DrawIVMSAlertShow(LONG lRealHandle, HDC hDc, void* pUser)
{
	SetBkMode(hDc, TRANSPARENT);
	SetTextColor(hDc, RGB(255, 255, 255));
	if(g_pDlgVcaIvmsCfg->m_bRuleActive)
	{
		g_pDlgVcaIvmsCfg->F_DrawFun(lRealHandle, hDc, pUser); 
	}
}
...
/*********************************************************
  ...
  Desc:		Set IVMS Behavior detection rule
  Input:	
  Output:	
  Return:	void
**********************************************************/
...
Return:	void
**********************************************************/
void CDlgVcaIvmsCfg::F_DrawFun(long lPlayHandle, HDC hDc, void* pUser)
{
	COLORREF color;
...
Return:	void
**********************************************************/
void CDlgVcaIvmsCfg::F_DrawFrame(long lRealHandle, HDC hDc, void* pUser, DWORD dwRuleID, COLORREF color)
{
...
Return:	void
**********************************************************/
void CDlgVcaIvmsCfg::F_DrawFilter(long lRealHandle, HDC hDc, void* pUser, DWORD dwRuleID, COLORREF color)
{
...
Return:	void
**********************************************************/
void CDlgVcaIvmsCfg::F_DrawLine(long lPlayHandle, HDC hDc, void* pUser, DWORD dwRuleID, COLORREF color)
{
    UNREFERENCED_PARAMETER(pUser);
...
//			AfxMessageBox("NET_DVR_RealPlay_V30 FAIL");		
		...
		{
			bRet = NET_DVR_RigisterDrawFunEx(m_lPlayHandle, DrawIVMSAlertShow, NULL);//set dc draw callback
		}
