...
void CALLBACK g_DrawRegionList(LONG lRealHandle, HDC hDc, void* pUser)
{
    g_pDlgRegionList->F_DrawFun(lRealHandle, hDc, pUser);
}
...
LONG CDlgRegionList::StartPlay()
{
    if (GetPuStreamCfg(m_struPUStream))
    {
        ...
        else
        {
            ...
            bRet = NET_DVR_RigisterDrawFunEx(m_lPlayHandle, g_DrawRegionList, NULL);//DC Draw callback
        }
...
void CDlgRegionList::F_DrawFun(long lPlayHandle, HDC hDc, void* pUser)
{
