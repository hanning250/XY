...
public:
	...
	//播放
	void Play();
	void F_DrawFun(long lPlayHandle, HDC hDc, void* pUser);
...
public:
    ...
    int m_iLinkageTime;
    int m_iFilterTime;
    BOOL m_bChkWhiteLight;
    BOOL m_bTraverseDetTargetOthers;
    BOOL m_bIntrusionDetTargetOthers;
    BOOL m_bEnterDetTargetAll;
    BOOL m_bEnterDetTargetHuman;
    BOOL m_bEnterDetTargetVehicle;
    BOOL m_bEnterDetTargetOthers;
    BOOL m_bExitDetTargetAll;
    BOOL m_bExitDetTargetHuman;
    BOOL m_bExitDetTargetVehicle;
    BOOL m_bExitDetTargetOthers;
    BOOL m_bChkIndicatorLightAlarm;
    BYTE m_bEnterDetTarget;
    BYTE m_bExitDetTarget;
    int m_iBrightnessLineDetection;
    int m_iAudioTypeLineDetection;
    int m_iTimeLineDetection;
    int m_iBrightnessFieldDetection;
    int m_iAudioTypeFieldDetection;
    int m_iTimeFieldDetection;
    BOOL m_bAudioAlarm;
    int m_enterAlaConfidence;
    int m_enterRecConfidence;
    int m_iAlarmConfidence;
    int m_iRecordConfidence;
    int m_iExitAlaConfidence;
    int m_iExitRecConfidence;
    int m_iIntrAlaConfidence;
    int m_iIntrRecConfidence;
};
