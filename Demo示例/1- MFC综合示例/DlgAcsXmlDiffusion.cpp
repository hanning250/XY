...
void CDlgAcsXmlDiffusion::OnBnClickedBtnGet()
{
    ...
    else    //POST
    {
        ...
        struInput.lpRequestUrl = szUrl;
        struInput.dwRequestUrlLen = strlen(szUrl);
        struInput.dwRecvTimeOut = 30000;    //门禁设备事件总条数获取超时时间为30s
...
void CDlgAcsXmlDiffusion::GetCommandStrAndInputParam()
{
    ...
    case 27: //通道控制器配置
        ...
        xmlInput.Parse("<ChannelControllerCfg>\
                            ...
                            <motorDirection>Clockwise</motorDirection>\
                            <lampBoardLight>50</lampBoardLight>\
                            <openSpeed>5</openSpeed>\
                            <closeSpeed>4</closeSpeed>\
...
\"employeeNo\":\"1\",\r\n                \"employeeNo\":\"2\",\r\n                \"employeeNo\":\"3\"\r\n            \
    ...
    case 43: //通道控制器设备类型配置
        m_bJsonFormat = TRUE;
        m_csCommandStr = "/ISAPI/AccessControl/channelControllerTypeCfg?format=json";
