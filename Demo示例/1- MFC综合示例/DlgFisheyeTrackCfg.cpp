...
void CALLBACK g_DrawFisheyeCalibPoint(LONG lRealHandle, HDC hDc, void* pUser)
{  
    //CDlgFisheyeTrackCfg* pDlg = (CDlgFisheyeTrackCfg*)(pUser);
...
void CALLBACK g_DrawTrackDevFun(LONG lRealHandle, HDC hDc, void* pUser)
{
    //CDlgFisheyeTrackCfg* pDlg = (CDlgFisheyeTrackCfg*)(pUser);
...
void CDlgFisheyeTrackCfg::StartTrackDevRealPlay()
{
	...
	else
	{
		...
		NET_DVR_RigisterDrawFunEx(m_lTrackDevRealhandle, g_DrawTrackDevFun, NULL);//DC Draw callback
	}
