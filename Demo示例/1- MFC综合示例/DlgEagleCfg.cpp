...
void CALLBACK g_DrawCalRgn(LONG lRealHandle, HDC hDc, void* pUser)
{
    CDlgEagleCfg* pDlg = (CDlgEagleCfg*)pUser;
...
void CDlgEagleCfg::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Text(pDX, IDC_EDIT_HEIGHT_VALUE, m_byHeightValue);
    DDX_Control(pDX, IDC_COMBO_HEIGHT_ENABLE, m_cbHeightEnabled);
}
...
void CDlgEagleCfg::OnBnClickedButtonEaset()
{
    ...
    m_struBuiltin_EAGLEFOCUSING_CTRL.byHeightCompensationEnable = m_cbHeightEnabled.GetCurSel();
    m_struBuiltin_EAGLEFOCUSING_CTRL.byHeightCompensationValue = m_byHeightValue;
...
void CDlgEagleCfg::OnBnClickedButtonEaget()
{
    ...
    m_cbHeightEnabled.SetCurSel(m_struBuiltin_EAGLEFOCUSING_CTRL.byHeightCompensationEnable);
    m_byHeightValue = m_struBuiltin_EAGLEFOCUSING_CTRL.byHeightCompensationValue;
