...
void CALLBACK DrawPDCShow(LONG lRealHandle, HDC hDc, void* pUser)
{
...
long CDlgPdcRuleCfg::StartRealPlay()
{
    ...
    {
        if (!NET_DVR_RigisterDrawFunEx(m_lPlayHandle, DrawPDCShow, NULL)) 
        {
...
void CDlgPdcRuleCfg::F_DrawPdcRule(LONG lRealHandle, HDC hDc, void* pUser)
{
...
/*********************************************************
  ...
  Return:	
**********************************************************/
void CDlgPdcRuleCfg::F_DrawFrame(long lRealHandle, HDC hDc, void* pUser,  COLORREF color)
{
...
void CDlgPdcRuleCfg::PDCDrawDirection(HDC hDc, void* pUser)
{
    CPen cpDrawPen;
