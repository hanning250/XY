...
CDlgFisheyePtzPlayWnd *g_DlgFisheyePtzPlayWnd = NULL;

void CALLBACK g_DrawFun(LONG lRealHandle, HDC hDc, void* pUser)
{  
    //CDlgFisheyePtzPlayWnd* pDlg = (CDlgFisheyePtzPlayWnd*)(pUser);
    if (g_DlgFisheyePtzPlayWnd != NULL)
    {
        g_DlgFisheyePtzPlayWnd->DrawFun(hDc);
    }
}
/////////////////////////////////////////////////////////////////////////////
...
BOOL CDlgFisheyePtzPlayWnd::StartRealPlay()
{
	...
	else
	{
		...
		bRet = NET_DVR_RigisterDrawFunEx(m_lRealHandle, g_DrawFun, NULL);//DC Draw callback
	}
	return bRet;
}
