...
void  CALLBACK g_DrawFaceSnap(LONG lRealHandle, HDC hDc, void* pUser)
{
    SetBkMode(hDc, TRANSPARENT);
    SetTextColor(hDc, RGB(255, 255, 255));
    
    g_pDlgVcaFaceSnap->F_DrawFun(lRealHandle, hDc, pUser);
}

void CDlgVcaFaceSnapCfg::F_DrawFun(long lPlayHandle, HDC hDc, void* pUser)
{
    F_DrawFrame(hDc);
}
...
LONG CDlgVcaFaceSnapCfg::StartPlay()
{
    ...
    else
    {
        ...
        bRet = NET_DVR_RigisterDrawFunEx(m_lPlayHandle, g_DrawFaceSnap, NULL);//DC Draw callback
    }
