...
void CALLBACK g_DrawTpsRule(LONG lRealHandle, HDC hDc, void* pUser)
{
    g_pDlgTpsRule->F_DrawFun(lRealHandle, hDc, pUser);
}
...
LONG CDlgTPSRuleCfg::StartPlay()
{
    if (GetPuStreamCfg(m_struPUStream))
    {
        ...
        else
        {
            ...
            bRet = NET_DVR_RigisterDrawFunEx(m_lPlayHandle, g_DrawTpsRule, NULL);//DC Draw callback
        }
...
void CDlgTPSRuleCfg::F_DrawFun(long lPlayHandle, HDC hDc, void* pUser)
{
