...
// void CALLBACK DrawDPCShow(LONG lRealHandle, HDC hDc, void* pUser)
// {
// // 	SetBkMode(hDc, TRANSPARENT);
// // 	SetTextColor(hDc, RGB(255, 255, 255));
// //	lpDPCCfgDlg->F_DrawFun(lRealHandle, hDc, pUser);     
// }
...
BOOL CDlgDPCCfg::Play()
{
	...
	//bRet = NET_DVR_RigisterDrawFunEx(m_lPlayHandle, DrawDPCShow, NULL);
