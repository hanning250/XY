...
void CALLBACK DrawDetectRule(LONG lRealHandle, HDC hDc, void* pUser)
{
    ...
    {
        g_pDlgVcaAtmFace->F_DrawDetectRule(lRealHandle, hDc, pUser);
    }
...
long CDlgVcaAtmFace::StartRealPlay()
{
    ...
    {
        if (!NET_DVR_RigisterDrawFunEx(m_lPlayHandle, DrawDetectRule, NULL))
        {
...
void CDlgVcaAtmFace::F_DrawDetectRule(LONG lRealHandle, HDC hDc, void* pUser)
{
