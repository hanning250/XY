...
public:
	...
	BOOL GetIvmsBehaviorCfg(); //IVMS Behavior detection rule
	BOOL SetIvmsBehaviorCfg(); //Set IVMS Behavior detection rule
	...
	void F_DrawFilter(long lRealHandle, HDC hDc, void* pUser, DWORD dwRuleID, COLORREF color);// draw area
