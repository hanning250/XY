...
BOOL CDlgCVR::OnInitDialog() 
{
	...
	g_StringLanType(szLanMachine, "IPv4", "IPv4");
	m_lstAddedMachine.InsertColumn(iIndex, szLanMachine, LVCFMT_LEFT, 100, -1);
	iIndex++;

    g_StringLanType(szLanMachine, "IPv6", "IPv6");
    m_lstAddedMachine.InsertColumn(iIndex, szLanMachine, LVCFMT_LEFT, 100, -1);
    iIndex++;
	...
	while (1)
	{
		...
		{	
			...
			if (0 == struAddedMachine.byType)
			{
				...
				csTmp.Format("%s", struAddedMachine.unionDevInfo.struWorkingDeviceInfo.struIP.byIPv6);
            ...
            else if (1 == struAddedMachine.byType)
			{
                ...
                csTmp.Format("%s", struAddedMachine.unionDevInfo.struRedundantDeviceInfo.struIP.byIPv6);
                pThis->m_lstAddedMachine.SetItemText(pThis->m_iMachineNum, 3, csTmp);
            ...
            else if (2 == struAddedMachine.byType)
            {
                ...
                csTmp.Format("%s", struAddedMachine.unionDevInfo.struWorkingDeviceInfoV50.struWorkingDeviceInfo.struIP.byIPv6);
                pThis->m_lstAddedMachine.SetItemText(pThis->m_iMachineNum, 3, csTmp);
                ...
                pThis->m_lstAddedMachine.SetItemText(pThis->m_iMachineNum, 18, csTmp);
            }
            else if (3 == struAddedMachine.byType)
            {
                ...
                csTmp.Format("%s", struAddedMachine.unionDevInfo.struRedundantDeviceInfoV50.struRedundantDeviceInfo.struIP.byIPv6);
                pThis->m_lstAddedMachine.SetItemText(pThis->m_iMachineNum, 3, csTmp);
