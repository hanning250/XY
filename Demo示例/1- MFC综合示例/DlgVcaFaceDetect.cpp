...
void  CALLBACK g_DrawFaceDetect(LONG lRealHandle, HDC hDc, void* pUser)
{
    SetBkMode(hDc, TRANSPARENT);
    SetTextColor(hDc, RGB(255, 255, 255));
    
    g_pDlgFaceDetect->F_DrawFun(lRealHandle, hDc, pUser);
}

void CDlgVcaFaceDetect::F_DrawFun(long lPlayHandle, HDC hDc, void* pUser)
{
    F_DrawFrame(hDc);
}
...
LONG CDlgVcaFaceDetect::StartPlay()
{
    ...
    else
    {
        ...
        bRet = NET_DVR_RigisterDrawFunEx(m_lPlayHandle, g_DrawFaceDetect, NULL);//DC Draw callback
    }
