...
void CALLBACK DrawMobileAlertShow(LONG lRealHandle, HDC hDc, void* pUser)
{
	SetBkMode(hDc, TRANSPARENT);
	SetTextColor(hDc, RGB(255, 255, 255));

	lpMobileDlg->F_DrawFun(lRealHandle, hDc, pUser);
}

void CDlgMobileTriggerCfg::F_DrawFun(long lPlayHandle, HDC hDc, void* pUser)
{
...
BOOL CDlgMobileTriggerCfg::Play()
{
	...
	bRet = NET_DVR_RigisterDrawFunEx(m_lPlayHandle, DrawMobileAlertShow, NULL);
