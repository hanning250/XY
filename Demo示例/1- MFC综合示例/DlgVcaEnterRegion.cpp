...
void CALLBACK DrawIVMSATMEnterRegionShow(LONG lRealHandle, HDC hDc, void* pUser)
{
	SetBkMode(hDc, TRANSPARENT);
	SetTextColor(hDc, RGB(255, 255, 255));

	g_pIVMSEnterAreaSet->F_DrawFun(lRealHandle, hDc, pUser);
}
...
void CDlgVcaEnterRegion::F_DrawFun(long lPlayHandle, HDC hDc, void* pUser)
{
...
void CDlgVcaEnterRegion::F_DrawFrame(long lRealHandle, HDC hDc, void* pUser,  COLORREF color)
{
...
LONG CDlgVcaEnterRegion::StartPlay()
{
    ...
    if (GetPuStreamCfg(m_struPuStream))
    {
        ...
        else
        {
            ...
            bRet = NET_DVR_RigisterDrawFunEx(m_lPlayHandle, DrawIVMSATMEnterRegionShow, NULL);//DC Draw callback
        }
