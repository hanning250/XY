...
void  CALLBACK g_DrawSizeFilter(LONG lRealHandle, HDC hDc, void* pUser)
{
    g_pDlgSizeFilter->F_DrawFun(lRealHandle, hDc, pUser);
}
...
LONG CDlgSizeFilter::StartPlay()
{
    if (GetPuStreamCfg(m_struPuStream))
    {
        ...
        else
        {
            ...
            bRet = NET_DVR_RigisterDrawFunEx(m_lPlayHandle, g_DrawSizeFilter, NULL);//DC Draw callback
        }
...
void CDlgSizeFilter::F_DrawFun(long lPlayHandle, HDC hDc, void* pUser)
{
