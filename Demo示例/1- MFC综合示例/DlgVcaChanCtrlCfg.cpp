...
BOOL CDlgVcaChanCtrlCfg::OnInitDialog()
{
	...
	{   
		g_StringLanType(szLan, "目标抓拍与识别", "Face Snap and Recognition");
        m_comboChanVcaType.InsertString(index, szLan);
	...
	{   
		g_StringLanType(szLan, "人脸采集", "Face Recognize");
        m_comboChanVcaType.InsertString(index, szLan);
	...
	{   
		g_StringLanType(szLan, "目标抓拍和异常行为检测", "BEHAVIOR_FACESNA");
        m_comboChanVcaType.InsertString(index, szLan);
    ...
    {   
        g_StringLanType(szLan, "SMART事件+道路布防", "Smart + Road Detection");
        m_comboChanVcaType.InsertString(index, szLan);
    ...
    {
        g_StringLanType(szLan, "道路布防", "Road Detection");
        m_comboChanVcaType.InsertString(index, szLan);
    ...
    {
        g_StringLanType(szLan, "城市管理检测", "CityManagement");
        m_comboChanVcaType.InsertString(index, szLan);
