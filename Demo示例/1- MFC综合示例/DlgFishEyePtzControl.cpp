...
CDlgFishEyePtzControl *g_DlgFishEyePtzControl = NULL;
...
void CALLBACK g_DrawFisheyevFun(LONG lRealHandle, HDC hDc, void* pUser)
{
    //CDlgFishEyePtzControl* pDlg = (CDlgFishEyePtzControl*)(pUser);
    //pDlg->DrawTrackDevFun(hDc);
    g_DlgFishEyePtzControl->DrawTrackDevFun(hDc);
}
/////////////////////////////////////////////////////////////////////////////
...
BOOL CDlgFishEyePtzControl::StartRealPlay()
{
	...
	else
	{
		...
		bRet = NET_DVR_RigisterDrawFunEx(m_lRealHandle, g_DrawFisheyevFun, NULL);//DC Draw callback
	}
	return bRet;
}
