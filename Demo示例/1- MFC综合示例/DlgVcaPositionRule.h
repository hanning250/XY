...
//	int  SetComboAlarmType(VCA_EVENT_TYPE uEVentType);
	...
	void F_DrawFrame(long lRealHandle, HDC hDc, void* pUser, DWORD dwRuleID, COLORREF color);
	void F_DrawFilter(long lRealHandle, HDC hDc, void* pUser, DWORD dwRuleID, COLORREF color);
	...
	void F_DrawLine(long lPlayHandle, HDC hDc, void* pUser, DWORD dwRuleID, COLORREF color);
...
public:
    ...
    CComboBox m_BackgroundSuppression;
    int m_iToiletTarryDelay;
    afx_msg void OnBnClickedBtnDelOneRule();
    afx_msg void OnStnClickedStaticToilettarryDelay();
};
