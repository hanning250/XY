...
void OperationMinorTypeMap(const NET_DVR_LOG_V50 &stLogInfo, CString &szTemp)
{
    ...
    case MINOR_OPERATION_PLANBROADCAST:
        ...
        break;
    case MINOR_LOCAL_IMPORT_DISHESDATA:
        szTemp.Format("%s", "MINOR_LOCAL_IMPORT_DISHESDATA");
        break;
    case MINOR_LOCAL_EXPORT_DISHESDATA:
        szTemp.Format("%s", "MINOR_LOCAL_EXPORT_DISHESDATA");
        break;
...
void InfoMinorTypeMap(NET_DVR_LOG_V50 stLogInfo, CString &szTemp)
{
    ...
    case MINOR_DELETE_ALL_VP:
        ...
        break;
    case MINOR_FACE_DATA_BASE_UPDATE_LOG_REC:
        szTemp.Format("%s", "MINOR_FACE_DATA_BASE_UPDATE_LOG_REC");
        break;
    default:
        szTemp.Format("0x%x", stLogInfo.dwMinorType);
        break;
...
void CDlgLogSearch::AddMinorString()
{
    ...
    m_comboMinorType.AddString(szTemp);
    iSel++;
    m_comboMinorType.SetItemData(iSel, MINOR_LOCAL_IMPORT_DISHESDATA);

    szTemp.Format("%s", "MINOR_LOCAL_EXPORT_DISHESDATA");
    m_comboMinorType.AddString(szTemp);
    iSel++;
    m_comboMinorType.SetItemData(iSel, MINOR_LOCAL_EXPORT_DISHESDATA);
