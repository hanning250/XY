...
//     else
//     {
//         if (!NET_DVR_RigisterDrawFunEx(m_lPlayHandle, DrawManualSnapShow, NULL)) 
//         {
...
void CDlgManualSnap::OnBtnManualSnap()
{
    ...
    else
    {
        ...
        case VCA_BKAIR_PLATE:
            g_StringLanType(szLan, "民航黑色", "Civil aviation black");
            csTemp.Format("%s", szLan);
            break;
        ...
        case VCA_ORANGE_PLATE:
            g_StringLanType(szLan, "橙色", "Orange");
            csTemp.Format("%s", szLan);
            break;

        case VCA_BROWN_PLATE:
            g_StringLanType(szLan, "棕色", "Brown");
            csTemp.Format("%s", szLan);
            break;
        ...
        case VCA_STANDARD92_PLATE:
            g_StringLanType(szLan, "标准民用车与特种车", "civil and green ");
            csTemp.Format("%s", szLan);
            //csTemp.Format("标准民用车与特种车");
            break;
        ...
        case VCA_CONSULATE_PLATE:
            g_StringLanType(szLan, "领事馆车牌", "Consulate Plate");
            csTemp.Format("%s", szLan);
            break;
        case VCA_EMERGENCY_PLATE:
            g_StringLanType(szLan, "应急车牌", "Emergency Plate");
            csTemp.Format("%s", szLan);
            break;
        case TRANSPORT_PLATE:
            g_StringLanType(szLan, "运输车", "Transport");
            csTemp.Format("%s", szLan);
            break;
        case COMMERCIAL_PLATE:
            g_StringLanType(szLan, "商用车", "Commercial");
            csTemp.Format("%s", szLan);
            break;
        case PRIVATE_PLATE:
            g_StringLanType(szLan, "私家车", "Private car");
            csTemp.Format("%s", szLan);
            break;
        case LEARNING_PLATE:
            g_StringLanType(szLan, "教练车", "Learning");
            csTemp.Format("%s", szLan);
            break;
        case CD_PLATE:
            g_StringLanType(szLan, "使馆车(CD)", "Embassy car(CD)");
            csTemp.Format("%s", szLan);
            break;
        case CC_PLATE:
            g_StringLanType(szLan, "使馆车(CC)", "Embassy car(CC)");
            csTemp.Format("%s", szLan);
            break;
        case SPECIAL_PLATE:
            g_StringLanType(szLan, "特种车", "Special car");
            csTemp.Format("%s", szLan);
            break;
        case PROTOCOL_PLATE:
        ...
        case GOVERNMENT_PLATE:
            g_StringLanType(szLan, "政府车", "Government Car");
            csTemp.Format("%s", szLan);
            break;
        case EXPORT_PLATE:
            ...
            csTemp.Format("%s", szLan);
        case TAXI_PLATE:
            g_StringLanType(szLan, "出租车", "Taxi");
            csTemp.Format("%s", szLan);
            break;
        case TESTING_PLATE:
        ...
        case TRANSFER_PLATE:
            ...
            break;
        case TRUCK_PLATE:
            g_StringLanType(szLan, "货车", "TRUCK");
            csTemp.Format("%s", szLan);
            break;
        case BUS_PLATE:
            g_StringLanType(szLan, "公交车", "BUS");
            csTemp.Format("%s", szLan);
            break;
        case PUBLIC_PLATE:
        ...
        case PRI_TRANS_PLATE:
            ...
            break;
        case TUMBREL_PLATE:
            g_StringLanType(szLan, "二轮车", "TUMBREL Plate");
            csTemp.Format("%s", szLan);
            break;
        case HONG_KONG_MACAO_PLATE:
            g_StringLanType(szLan, "港澳入出车", "Hong Kong and Macao Plate");
            csTemp.Format("%s", szLan);
            break;
        default:
            g_StringLanType(szLan, "未知", "UnKnow");
