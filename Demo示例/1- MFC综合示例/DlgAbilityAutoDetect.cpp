...
void CDlgAbilityAutoDetect::OnBtnGet() 
{
    ...
    if (m_dwReturnValue != 0)
    {
        ...
        m_strDevAbility = str_gb2312.c_str();
...
void CDlgAbilityAutoDetect::OnSelchangeCmbAbilityType() 
{
    ...
    case 250: //门禁事件获取能力
        ...
        break;
    case 251://获取禁止名单人脸比对布防时间能力
        m_bSTDAbility = TRUE;
        m_dwAbilityType = NET_DVR_GET_BLOCKLIST_FACECONTRAST_SCHEDULE_CAPABILITIES;
        m_strInputParam = "1";
        break;
    case 252://获取允许名单人脸比对布防时间能力
        m_bSTDAbility = TRUE;
        m_dwAbilityType = NET_DVR_GET_ALLOWLIST_FACECONTRAST_SCHEDULE_CAPABILITIES;
        m_strInputParam = "1";
        break;
    case 253: //人脸比对配置能力
        m_dwAbilityType = 0xffffffff;
